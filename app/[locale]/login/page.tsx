...
export default function AdminLoginPage() {
  ...
  async function onSubmit(values: LoginFormValues) {
    setLoading(true);
    // login function from useAuth returns an object, it does not throw
    const result = await login(values);

    if (result.success) {
      toast.success("Başarıyla giriş yaptınız! Yönlendiriliyorsunuz...");
      setTimeout(() => {
        router.push(`/${locale}/admin/dashboard`); // Use locale prefix for redirect
      }, 1000);
    } else {
      toast.error(
        "Giriş yapılırken hata oluştu! Lütfen bilgilerinizi kontrol edin."
      );
    }
  ...
  const features = [
    {
      ...
      description:
        "Video dersler, quizler ve ödevlerle zenginleştirilmiş eğitim içerikleri",
    },
    {
      icon: Users,
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-linear-to-br from-blue-600 via-purple-600 to-indigo-800 relative overflow-hidden">
        {/* Background Pattern */}
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 py-16 text-white">
          ...
          <div className="flex items-center space-x-3 mb-12">
            ...
            <div>
              <h1 className="text-2xl font-bold">Kovancılar Matematik</h1>
          ...
          <div className="space-y-6">
            {features.map((feature, index) => (
              ...
              >
                <div className="shrink-0 w-10 h-10 bg-white/20 rounded-lg flex items-center justify-center group-hover:bg-white/30 transition-colors">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gray-50 dark:bg-gray-900">
        <div className="w-full max-w-md space-y-8">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <Button
              type="submit"
              className="w-full h-12 bg-linear-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-medium rounded-lg transition-all duration-200 transform hover:scale-[1.02] disabled:transform-none"
              disabled={loading}
            >
              {loading ? (
                <>
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
            ...
            <div className="text-xs text-blue-700 dark:text-blue-300 space-y-1">
              ...
              <div>
                👨‍🏫 Öğretmen: ahmet.ogretmen@egitimplatformu.com / sifre123
              </div>
